...
bezier_value_at_cpp <- function(pts, t) {
  .Call(`_rasengan_bezier_value_at_cpp`, pts, t)
}

bezier_derivative_at_cpp <- function(pts, t) {
  .Call(`_rasengan_bezier_derivative_at_cpp`, pts, t)
}

bezier_normal_at_cpp <- function(pts, t) {
  .Call(`_rasengan_bezier_normal_at_cpp`, pts, t)
}

bezier_tangent_at_cpp <- function(pts, t) {
